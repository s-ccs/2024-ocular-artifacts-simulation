...
begin
	...
	# positions of left and right eyeball points in eyemodel
...
begin
	...
	arrows!(point3fs_o, vectors_o.*6, arrowsize=0.3)
	WGLMakie.scatter!(eyeall_center_L,color="red")
	WGLMakie.scatter!(eyeall_center_R,color="red")
	WGLMakie.scatter!(eye_center_L,color="blue")
	WGLMakie.scatter!(eye_center_R,color="blue")
...
begin
	...
	eyemodel["orientation"][eyemodel_right_idx,:] = calc_eye_orientations(eyeall_center_R, em_positions_R)
	
	eyemodel["orientation"][eyemodel_left_idx,:] = calc_eye_orientations(eyeall_center_L, em_positions_L)
