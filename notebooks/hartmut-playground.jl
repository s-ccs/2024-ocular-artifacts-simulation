...
begin
	function calc_orientations(center, positions)
...
begin
	...
	eyemodel["orientation"][eyemodel_left_idx,:] = calc_orientations(eyeall_center_L, em_positions_L)

	eyemodel["orientation"][lsi_eyemodel["Cornea"],:] = eyemodel["orientation"][lsi_eyemodel["Cornea"],:] .* -1 # cornea and retina have opposite orientations: cornea away from the center, so reverse the calculated towards-center orientations.
...
begin
	...
	plot_topoplot!(
		f_topopolots_eyesim2[2,1], mag_eyemodel_cornea, positions=pos2d, visual = (; enlarge = 0.65, label_scatter = false),)
	plot_topoplot!(
...
git-tree-sha1 = "3a737a661e09ecdcd186c4e5d76116186fc500f6"
